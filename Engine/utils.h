...
#pragma region DirectionFunctionality
	enum class Direction
	{
		left, upLeft, up, upRight, right, downRight, down, downLeft
	};
#pragma endregion DirectionFunctionality
...
#pragma region ColorFunctionality
	Color4f RgbIntToColor(int r, int g, int b, float a = 1.f);
#pragma endregion ColorFunctionality

#pragma region PositionFunctionality
	Point2f GetCenterOfRectangle(const float left, const float bottom, const float width, const float height);
	Point2f GetCenterOfRectangle(const Rectf& rect);
	Point2f GetCenterOfRectangle(const Point2f bottomLeft, const float width, const float height);

	Point2f GetElementCenterOfRectangle(const Rectf& rect, const Texture& text);
	Point2f GetElementCenterOfRectangle(const Rectf& rect, const Rectf& element);
